  ...
  setHTML('navbar', `
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="mainNav">
        ...
        <a href="contact.html" class="btn btn-brand">
      ...
      <div class="container">
        <div class="row align-items-center g-5">
          <div class="col-lg-7">
            <div class="reveal">
              <h1 class="hero-title">
                ${hero.titlePrefix} <span class="typing-text" data-words='${encodeURIComponent(JSON.stringify(hero.typingWords || []))}'></span>
              </h1>
              <p class="hero-desc">
                ${hero.description || ''}
              </p>
...
const contact = state.data.contact || {};
  const contacts = (contact.stats || []).map(stat => `
    <div class="col-6 col-md-4">
      <div class="metric-box">
        <h3 class="counter" data-target="${contacts.title}">0</h3>
        <p class="mb-0 text-muted">${contacts.description}</p>
      </div>
    </div>
  `).join('');
}
